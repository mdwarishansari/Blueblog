  ...
  return (
    ...
    >
      ...
      {post.bannerImage?.url && (
        <div className="mb-10 aspect-video overflow-hidden rounded-2xl bg-slate-200 elev-sm animate-fade-in hover-glow">
          <Image
            src={post.bannerImage.url}
            alt={post.bannerImage.altText || post.title}
            width={1280}
            height={720}
            className="h-full w-full object-cover ui-transition hover:scale-105"
            priority
          />
        </div>
      )}
      ...
      {/* Categories */}
      <div className="mb-4 flex flex-wrap gap-2 animate-fade-in-up stagger-1">
        {post.categories.map(cat => (
          <Link
            ...
            className="
                ...
                ui-transition hover:bg-indigo-100 hover:shadow-md
              "
          >
      ...
      {/* Title */}
      <h1 className="mb-5 text-4xl font-extrabold leading-tight tracking-tight text-fg animate-fade-in-up stagger-2">
        {post.title}
      </h1>

      {/* Meta */}
      <div className="mb-12 flex items-center gap-6 text-sm text-slate-600 animate-fade-in-up stagger-3">
        <span
      ...
      {/* Article body */}
      <section className="rounded-2xl bg-card p-10 elev-sm animate-fade-in-up stagger-4 hover-glow">
        <div
          className="
