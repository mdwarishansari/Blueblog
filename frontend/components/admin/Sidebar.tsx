...
export default function Sidebar({ user, onLogout }: SidebarProps) {
  ...
  const navItems = [
  { icon: FiHome, label: 'Dashboard', href: '/admin/dashboard', roles: ['ADMIN', 'EDITOR', 'WRITER'] },
  { icon: FiFileText, label: 'Posts', href: '/admin/posts', roles: ['ADMIN', 'EDITOR', 'WRITER'] },
  { icon: FiFolder, label: 'Categories', href: '/admin/categories', roles: ['ADMIN', 'EDITOR'] },
  { icon: FiImage, label: 'Media', href: '/admin/images', roles: ['ADMIN', 'EDITOR'] },
  { icon: FiUser, label: 'Users', href: '/admin/users', roles: ['ADMIN'] },
  { icon: FiSettings, label: 'Settings', href: '/admin/settings', roles: ['ADMIN'] },
];
