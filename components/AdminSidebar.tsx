  ...
  const MobileToggle = (
    <button
      ...
      className="
        ...
        rounded-full bg-pure-white border border-hairline shadow-sm
  ...
  const SidebarContent = (
    <motion.aside
      ...
      className="
        ...
        bg-pure-white border-r border-hairline
    ...
    >
      ...
      <div className="flex h-16 items-center justify-between px-4">
        ...
        <Button
          ...
          className="hidden lg:inline-flex h-8 w-8 rounded-full border border-hairline hover:bg-canvas-cream"
        >
          ...
          return (
            ...
            >
              ...
              <Link
                ...
                className={cn(
                  'relative z-10 flex items-center gap-3 rounded-full px-4 py-2.5 text-sm font-medium transition-all duration-200',
                  active
                    ? 'text-ink-charcoal'
      ...
      <div className="p-4 border-t border-hairline">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="truncate">
              ...
              <p className="text-xs font-medium text-electric-cobalt mt-0.5">{user.role}</p>
            </div>
          )}
        </div>
        ...
        <form action="/api/auth/logout" method="POST" className="mt-4">
          <Button
            variant="ghost"
            className="w-full justify-start text-red-600 hover:bg-red-50 rounded-full"
          >
